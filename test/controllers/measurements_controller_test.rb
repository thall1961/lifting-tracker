...
class MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post measurements_url, params: { measurement: { inches: @measurement.inches, position: @measurement.position } }
    end
  ...
  test "should update measurement" do
    patch measurement_url(@measurement), params: { measurement: { inches: @measurement.inches, position: @measurement.position } }
